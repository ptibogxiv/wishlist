...
if ($socid && $action == 'create' && $user->rights->wishlist->create)
{
	...
	print '<td>';
  			if (! empty($conf->global->ENTREPOT_EXTRA_STATUS))
			{
				...
				$form->select_produits(GETPOST('productid', 'int'), 'productid', '', getDolGlobalInt('limit_size'), $object->price_level, 1, 2, '', 1, array(), $object->id, '1', 0, 'maxwidth300', 0, 'warehouseopen,warehouseinternal', GETPOST('combinations', 'array'));
			}
			else
			{
				$form->select_produits(GETPOST('productid', 'int'), 'productid', '', getDolGlobalInt('limit_size'), $object->price_level, 1, 2, '', 1, array(), $object->id, '1', 0, 'maxwidth300', 0, '', GETPOST('combinations', 'array'));
			}
  print '</td></tr>';
